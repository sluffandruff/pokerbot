...
# board = [eval7.Card(card) for card in ["Ad", "Jc", "9s"]]
# print(eval7.py_hand_vs_range_monte_carlo(hole_cards, ALL_HANDS, board, 1000))

# import time
# eq = {}
# start = time.perf_counter()
# for hand in ALL_HANDS.hands:
#     eq[hand] = eval7.py_hand_vs_range_monte_carlo(hand[0], ALL_HANDS, board, 1000)
# s = sorted(ALL_HANDS.hands, key=lambda x: eq[x])
