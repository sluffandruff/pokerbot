    ...
    def allocate_cards(self, my_cards):
        ...
        for i in range(5):
            for j in range(i + 1, 6):
                ...
                equities[hand] = eval7.py_hand_vs_range_monte_carlo(map(eval7.Card, hand), self.opp_range, [], 10000)
    ...
    def get_actions(self, game_state, round_state, active):
        ...
        if street != self.street_tracker:
            ...
            for i in range(NUM_BOARDS):
                ...
                self.hole_strengths[i] = eval7.py_hand_vs_range_monte_carlo(hand, self.opp_range, board, 10000)
