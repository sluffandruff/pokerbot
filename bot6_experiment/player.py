    ...
    def get_actions(self, game_state, round_state, active):
        ...
        for i in range(NUM_BOARDS):
            ...
            if AssignAction in legal_actions[i]:
                ...
                print(game_state.round_num, street, strength)
                ...
                #         my_actions[i] = FoldAction()
                    ...
                    if (street < 3 and strength > 0.8) or (street == 3 and strength > 0.83) or (street == 4 and strength > 0.85) or (strength > 0.87):
                        ...
                        if RaiseAction in legal_actions[i] and raise_amount <= 5 and raise_amount - my_pips[i] <= my_stack - net_cost and random.random() < strength/2:
